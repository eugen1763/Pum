...
export const SETTINGS_ROWS: readonly SettingRow[] = [
  ...
  { id: "checkMode", label: "Check mode", category: "Safety", keywords: "on off verify tools hard block bash edit trigger process", description: "Turn Check mode on or off. On checks bash, edit, and external-trigger process proposals, with hard security rules." },
