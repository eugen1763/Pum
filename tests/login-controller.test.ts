...
import { filterLoginMethods, LoginController } from "../src/login-controller";
import type { LoginPage } from "../src/login-popup";
...
describe("login controller", () => {
  ...
  test("does not persist a custom provider after the setup is cancelled", async () => {
    ...
    const controllerModule = new URL("../src/login-controller.ts", import.meta.url).href;
    const script = [
