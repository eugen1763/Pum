...
import { maxStatsScrollOffset, StatsPopup, statsLines, statsPopupGeometry, statsToneColor } from "../src/stats-popup";
import type { SessionStatsSnapshot } from "../src/session-stats";
