...
import { AFK_RULE_STATES, afkLabelColor, modeLineLabels, type AfkRuleState } from "../src/mode-line";
import {
  MIN_RULE_COLUMNS,
...
import { createGoal, type GoalRecord, type GoalState } from "../src/goal";
import { statusTextWidth } from "../src/status-metadata";
import { PRESET_NAMES, loadTheme } from "../src/theme";
